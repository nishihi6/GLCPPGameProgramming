...
UIScreen::UIScreen(Game* game)
	...
	// Add to UI Stack
	mGame->PushUI(this);
	mFont = mGame->GetFont("11/Assets/Carlito-Regular.ttf");
	mButtonOn = mGame->GetRenderer()->GetTexture("11/Assets/ButtonYellow.png");
	mButtonOff = mGame->GetRenderer()->GetTexture("11/Assets/ButtonBlue.png");
}
