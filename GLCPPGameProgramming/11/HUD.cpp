...
HUD::HUD(Game* game)
	...
	mHealthBar = r->GetTexture("11/Assets/HealthBar.png");
	mRadar = r->GetTexture("11/Assets/Radar.png");
	mCrosshair = r->GetTexture("11/Assets/Crosshair.png");
	mCrosshairEnemy = r->GetTexture("11/Assets/CrosshairRed.png");
	mBlipTex = r->GetTexture("11/Assets/Blip.png");
	mRadarArrow = r->GetTexture("11/Assets/RadarArrow.png");
}
